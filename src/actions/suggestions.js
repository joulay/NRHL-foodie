...
export const fetchSuggestions = (price) => dispatch => {
    ...
    console.log(price)
    fetch(`https://fast-beach-47884.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=food&sort_by=rating&limit=50&latitude=34.048203&longitude=-118.258949&radius=805&price=${price}`, {
      method: "GET",
      dataType: "JSON",
      headers: {
